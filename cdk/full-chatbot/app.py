...
class ChatbotInfrastructureStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.portfolio_news_lambda = self._create_portfolio_news_lambda()
    ...
    def _create_bedrock_agent_role(self) -> iam.Role:
        ...
        # Use '*' for Bedrock model resource to avoid region-specific ARN issues
        return iam.Role(
    ...
    def _create_portfolio_news_lambda(self) -> _lambda.Function:
        """Create Portfolio News Lambda function"""
        return _lambda.Function(
            self, "PortfolioNewsFunction",
            runtime=_lambda.Runtime.PYTHON_3_12,
            handler="lambda_function.lambda_handler",
            code=_lambda.Code.from_asset(
                "../src/lambda_functions/portfolio_news",
                bundling=cdk.BundlingOptions(
                    image=_lambda.Runtime.PYTHON_3_12.bundling_image,
                    command=[
                        "bash", "-c",
            ...
            function_name="ChatbotPortfolioNews",
            description="Portfolio news aggregation for AI chatbot"
        )
    ...
    def _create_log_groups(self):
        ...
        functions = [
            ...
            ("PortfolioNewsLogGroup", self.portfolio_news_lambda)
        ]
    ...
    def _create_outputs(self):
        ...
        CfnOutput(
            self, "PortfolioNewsLambdaArn",
            value=self.portfolio_news_lambda.function_arn,
            description="Portfolio News Lambda Function ARN"
        )
